    ...
    <main class="clearfix">
        ...
        <section class="subscribe clearfix">
            ...
            <div class="subscribe-link">
                ...
                <a href="http://blog.kijani.co/rss"></a>
                <h4></h4>
            </div>
            <div class="subscribe-link">
                <svg viewBox="0 0 94 80">
                ...
                <a href="https://twitter.com/KijaniNGO"></a>
                <h4></h4>
            </div>
            <div class="subscribe-link">
                <svg viewBox="0 0 94 80">
                ...
                <a href="https://www.youtube.com/c/KijaniCommunity"></a>
                <h4></h4>
            </div>
            <div class="subscribe-link">
                <svg viewBox="0 0 94 80">
                ...
                <a href="https://www.facebook.com/kijani.ngo"></a>
                <h4></h4>
            </div>
        </section>

        <section class="archive clearfix">
            <?php
            if ( $query->have_posts() ) :
                while ( $query->have_posts() ) :
                    $query->the_post();
            ?>
            <a class="box article" href="<?php echo get_permalink(); ?>">
                <?php if ( has_post_thumbnail() ): $article_thumb_url = wp_get_attachment_image_src( get_post_thumbnail_id(), 'medium' ); ?>
